...
export class FullReportModel {
    ...
    constructor(srm: SimpleReportModel, screener_id: number, candidate: Candidate, aboutMeCommentary: string, generalCommentary: string,
        softSkillCommentary: string, softSkillVerdict: boolean, categoriesTested: CategoryModel[], violationsObserved: ViolationModel[]) {
        this.srm = srm;
