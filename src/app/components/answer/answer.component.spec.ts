...
describe('AnswerComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [ NgbActiveModal, QuestionScoreService, HttpClient, HttpHandler, 
      UrlService, SoftSkillsViolationService, SimpleTraineeService, SkillTypesService, ViolationTypeService, AlertsService]
    })
    .compileComponents();
  }));
