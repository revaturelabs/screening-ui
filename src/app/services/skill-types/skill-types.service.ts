...
export class SkillTypesService {
  ...
  createSkillType(skillType: SkillType) {
    return this.http.post<SkillType>(
  ...
  activateSkillType(skillType: SkillType) {
    return this.http.put(
      this.urlService.skillTypes.putSkillType(skillType.skillTypeId),
      skillType,
      httpOptions
    );
  }
  ...
  updateSkillTypeBuckets(skillType: SkillType, bucketIds, weights) {
    return this.http.put(
      this.urlService.skillTypes.updateSkillTypeBuckets(skillType.skillTypeId),
      {
        title: skillType.title,
        skillTypeId: skillType.skillTypeId,
        bucketIds: bucketIds,
  ...
  getSkillTypeById(skillTypeId: number) {
    return this.http.get(
      this.urlService.skillTypes.getSkillTypeById(skillTypeId)
    );
  }
