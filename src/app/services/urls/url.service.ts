...
export class UrlService {
  ...
  screening = {
    ...
    startScreening: () =>
      `${this.screeningContext + this.screeningEndpoint}/new`,
    startScreeninging: () =>
      `${this.screeningContext + this.screeningEndpoint}/newest`,
    endScreening: () =>
      `${this.screeningContext + this.screeningEndpoint}/update`,
    updateScreening: () =>
      `${this.screeningContext + this.screeningEndpoint}/update`,
