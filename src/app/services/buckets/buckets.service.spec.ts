...
describe('BucketsService', () => {
  ...
  it('getAllBuckets should return expected buckets', () => {
    ...
    bucketsService = new BucketsService(
    ...
    bucketsService
      ...
      .subscribe(
        fetchedBuckets =>
          expect(fetchedBuckets).toEqual(expectedBuckets, 'expected buckets'),
        fail
      );
  ...
  it('createNewBucket should return new Bucket', () => {
    ...
    bucketsService
      .createNewBucket(Bucket[0])
      .subscribe(bucketList => expect(bucketList).toEqual(Bucket[0]), fail);
  ...
  it('updateBucket should return bucket with updated values', () => {
    ...
    bucketsService
      .updateBucket(mockbucket)
      .subscribe(bucketList => expect(bucketList).toEqual(mockbucket), fail);
